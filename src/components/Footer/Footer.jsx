  ...
  return (
    ...
    <div className="contact-section">
      ...
      <p className='para-footer'>
        Our friendly customer service representatives are always happy to answer your questions and offer further advice.
      </p>
    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-col">
          ...
          <p>
            Our company offers a wide range of travel services, including customized tours,
            adventure travel, cultural immersion experiences, and more...
          </p>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><Link to="#">Pay to Service</Link></li>
          </ul>
        </div>
        <div className="footer-col">
          <h4>Contact</h4>
