...
function Pakages() {
  ...
  const handleSubmit = (event) => {
    ...
    setErrors({});
    navigate("/selected-area", {
      state: { packageName, date, rooms, adults, children, infants },
    });
  };
    ...
    <div className="h-main-container">
      <div id="header-button">
        <div className="inner-header-btn">
          ...
          >
            <i className="icon fa-solid fa-box"></i> Packages
          </button>
          <Link to="/services">
            <button
              className={`nav-button ${activeTab === "cars" ? "active" : ""}`}
            >
              <i className="icon fa-solid fa-car-rear"></i> Cars
            </button>
          </Link>
          <button
            className={`nav-button ${activeTab === "mice" ? "active" : ""}`}
          >
            MICE
          </button>
          <button
            className={`nav-button ${activeTab === "gift" ? "active" : ""}`}
          >
            Gift Cards
          </button>
        </div>
          ...
          <div className="inner-white">
            <div className="parent-pkg">
              <div className="child1-pkg">
                <label className="labell" htmlFor="packages">
                  Packages
                </label>
                <input
                  className={`inputt ${
                    errors.packageName ? "input-error" : ""
                  }`}
                  type="text"
                  id="packages"
                ...
                />
                {errors.packageName && (
                  <p className="error-text">{errors.packageName}</p>
                )}
              </div>

              <div className="child2-pkg">
                <label className="labell" htmlFor="date">
                  Select Date
                </label>
                <input
                  ...
                  {isDropdownOpen && (
                    <div className="inner-drop">
                      ...
                      <div className="combine-grp">
                        <div className="input-group">
                          <label>
                            <span>Adults</span> Above 12 years
                          </label>
                          <div className="counter">
                            <button
                              type="button"
                        ...
                        <div className="input-group">
                          <label>
                            <span>Children</span> Below 12 years
                          </label>
                          <div className="counter">
                            <button
                              type="button"
                      ...
                      <div className="input-group">
                        <label>
                          <span>Infants</span> Less than 2 years
                        </label>
                        <div className="counter">
                          <button
                            type="button"
